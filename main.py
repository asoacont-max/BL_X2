...
<body>
  <div class="wrap">
    ...
    write_if_missing(os.path.join(server_dir, 'main.py'), """# 🚀 بوت افتراضي - BL_X2 HOSTING
import time
print("=" * 40)
print("البوت يعمل على BL_X2 HOSTING")
print("الخادم جاهز!")
print("=" * 40)
عداد = 0
while True:
...
@app.route("/")
def home():
    return "<h1>BL_X2 Hosting - Flask App</h1>"
...
const server = http.createServer((req, res) => {
  ...
  res.end('<h1>BL_X2 Hosting - Node.js App</h1>');
});
...
echo "<h1>BL_X2 Hosting - PHP Website</h1>";
?>
""")
        ...
        write_if_missing(os.path.join(server_dir, 'script.js'), "console.log('BL_X2 Hosting');")
# ============================================
...
<head>
  <meta charset="UTF-8">
  <meta name="viewport" content="width=device-width, initial-scale=1.0">
  <title>BL_X2 | Site Browser</title>
  <style>
    body{margin:0;font-family:Arial,sans-serif;background:#0b0f14;color:#e5eef7;direction:rtl}
...
def api_create_server():
    ...
    if not username:
        username = f"BL_X2_CODEX{random.randint(10000, 99999)}"
...
if __name__ == '__main__':
    ...
    print("\n" + "=" * 50)
    print("🚀 استضافة البوتات - BL_X2 HOSTING")
    print("=" * 50)
